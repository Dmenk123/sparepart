        ...
        <div class="container">
            ...
            <div class="footer_copyright">
                <h5>© 
                    ...
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Build with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://jmpmotor.com" target="_blank">JMP-Motor</a>
                </h5>
            </div>
        </div>
    </footer>
