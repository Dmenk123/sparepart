                ...
                <div class="row">
                        ...
                        <div class="top_header_left">
                            <div class="selector">
                                <select class="language_drop" name="countries" id="countries" style="width:300px;">
                                  <option value='yt' data-image="<?php echo base_url();?>assets/fo/img/icon/flag-1.png" data-imagecss="flag yt" data-title="English">English</option>
                                  <option value='yu' data-image="<?php echo base_url();?>assets/fo/img/icon/flag-1.png" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                                  <option value='yt' data-image="<?php echo base_url();?>assets/fo/img/icon/flag-1.png" data-imagecss="flag yt" data-title="English">English</option>
                                  <option value='yu' data-image="<?php echo base_url();?>assets/fo/img/icon/flag-1.png" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                                </select>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="top_header_middle">
                            ...
                            <img src="<?php echo base_url();?>assets/fo/img/logo.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3">
        ...
        <section class="main_slider_area">
            <div class="container">
                <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
                    <ul>
                        <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="<?php echo base_url();?>assets/fo/img/home-slider/slider-1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url();?>assets/fo/img/home-slider/slider-1.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                ...
                <div class="row feature_inner">
                    <div class="col-lg-5">
                        <div class="f_add_item">
                            <div class="f_add_img"><img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/feature-add/f-add-1.jpg" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="f_add_item right_dir">
                            <div class="f_add_img"><img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/feature-add/f-add-2.jpg" alt=""></div>
                            <div class="f_add_hover">
                                <h4>Best Summer <br />Collection</h4>
                                <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="f_add_item">
                            <div class="f_add_img"><img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/feature-add/f-add-3.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="l_product_slider owl-carousel">
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-1.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                                <ul>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-5.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                    ...
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-2.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-6.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                    ...
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-3.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-7.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                    ...
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-4.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="<?php echo base_url();?>assets/fo/img/product/l-product-8.jpg" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="f_add_item white_add">
                            <div class="f_add_img"><img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/feature-add/f-add-4.jpg" alt=""></div>
                            <div class="f_add_hover">
                                <h4>Best Summer <br />Collection</h4>
                                <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="f_add_item white_add">
                            <div class="f_add_img"><img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/feature-add/f-add-5.jpg" alt=""></div>
                            <div class="f_add_hover">
                                <h4>Best Summer <br />Collection</h4>
                                <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                            </div>
                ...
                <div class="row p_listing_inner">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-4">
                                <div class="p_list_img">
                                    <img src="<?php echo base_url();?>assets/fo/img/product/p-categories-list/product-l-1.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-4">
                                <div class="p_list_img">
                                    <img src="<?php echo base_url();?>assets/fo/img/product/p-categories-list/product-l-2.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-4">
                                <div class="p_list_img">
                                    <img src="<?php echo base_url();?>assets/fo/img/product/p-categories-list/product-l-3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="related_product_inner">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/product/related-product/r-product-1.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/product/related-product/r-product-2.jpg" alt="">
                                    <h5 class="new">New</h5>
                                </div>
                                <div class="l_p_text">
                                   <ul>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/product/related-product/r-product-3.jpg" alt="">
                                </div>
                                <div class="l_p_text">
                                   <ul>
                                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/product/related-product/r-product-4.jpg" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="from_blog_item">
                                <img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/blog/from-blog/f-blog-1.jpg" alt="">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="from_blog_item">
                                <img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/blog/from-blog/f-blog-2.jpg" alt="">
                                <div class="f_blog_text">
                                    <h5>fashion</h5>
                                    <p>Neque porro quisquam est qui dolorem ipsum</p>
                                    <h6>21.09.2017</h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="from_blog_item">
                                <img class="img-fluid" src="<?php echo base_url();?>assets/fo/img/blog/from-blog/f-blog-3.jpg" alt="">
                                <div class="f_blog_text">
                                    <h5>fashion</h5>
                                    <p>Neque porro quisquam est qui dolorem ipsum</p>
                                    <h6>21.09.2017</h6>
