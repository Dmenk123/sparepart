            ...
            <div class="kt-widget__content">
              <div class="kt-widget__section">
                <a href="#" class="kt-widget__username">
                  <?php if($data_klinik) {echo $data_klinik->nama_usaha; }?>
                  ...
                  <div class="kt-section kt-section--first">
                    <div class="kt-section__body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                          <input class="form-control" type="text" value="<?php if($data_klinik) { echo $data_klinik->nama_usaha; }?>" name="nama">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="<?php if($data_klinik) { echo $data_klinik->telp; }?>" placeholder="Nomor Telp" aria-describedby="basic-addon1" name="telp">
                          </div>
                        </div>
                      </div>
                      <div class="form-group row">
